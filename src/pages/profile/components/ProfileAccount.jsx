    ...
    <>
      ...
      {/* Profile Info */}
        ...
        <div className="max-w-md">
          <h2 className="text-[#002A3C] text-lg font-semibold mb-6">
            Personal details
          </h2>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center">
              ...
              <button className="text-[#43B3E5] text-sm font-medium">
                Edit
              </button>
            </div>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center">
              <label className="text-sm text-[#002A3C] font-medium">
                Email address
              </label>
              <button className="text-[#43B3E5] text-sm font-medium">
                Edit
        ...
        <div className="max-w-md">
          <h2 className="text-[#002A3C] text-lg font-semibold mb-4">
            Manage account
          </h2>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center">
              ...
              <button className="text-[#FF3535] text-sm font-medium">
                Delete
              </button>
            </div>
            <p className="text-sm text-[#4A4A4A] mt-1">
